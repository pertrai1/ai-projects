...
* **[Heapify Algorithm (Interactive Simulator Game)](../algorithms/heapify/index.html) (Build from array):** $\mathcal{O}(K)$ — Optimized bottom-up construction.
...
1. **[LC 215: Kth Largest Element (Interactive RAG Simulator Game)](index.html)** (Classic Min-Heap tracking)
