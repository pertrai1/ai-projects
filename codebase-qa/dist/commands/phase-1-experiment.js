...
export async function runPhase1Experiment(codebaseDir) {
    console.log(`
╔════════════════════════════════════════════════════════════════╗
...
function displayResults(experiments) {
    ...
    console.log('='.repeat(80));
    const bestRecall = experiments.reduce((best, exp) => exp.retrieval.metrics.recall > best.retrieval.metrics.recall ? exp : best);
    const bestPrecision = experiments.reduce((best, exp) => exp.retrieval.metrics.precision > best.retrieval.metrics.precision ? exp : best);
...
//# sourceMappingURL=phase-1-experiment.js.map